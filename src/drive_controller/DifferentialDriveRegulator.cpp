...
DifferentialDriveRegulator::DifferentialDriveRegulator(double const kP_1, double const kI_1, double const kD_1,
...
: _linear_x_regulator               (kP_1, kI_1, kD_1, dt_s, LINEAR_X_MIN_SPEED_m_per_s,    LINEAR_X_MAX_SPEED_m_per_s),
  _angular_z_regulator              (kP_2, kI_2, kD_2, dt_s, ANGULAR_X_MIN_SPEED_deg_per_s, ANGULAR_X_MAX_SPEED_deg_per_s),
