...
void getSpeedFromRegulator    (MD49Regulator const &md49_regulator,
                               int8_t        &      speed_1,
                               int8_t        &      speed_2);
...
void getSpeedFromRegulator(MD49Regulator const &md49_regulator, int8_t &speed_1, int8_t &speed_2)
{
